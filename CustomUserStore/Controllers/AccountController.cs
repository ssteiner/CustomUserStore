...
using CustomUserStore.UserManagement;
...
namespace CustomUserStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl, string subDomain = null)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new CustomStringUser(model.Email, model.Email);
                user.EmailConfirmed = true; // we don't use email confirmation at this point
